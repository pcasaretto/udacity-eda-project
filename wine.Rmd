...
```{r echo=FALSE, Linear_Model_Acids}
acidsLM <- lm(pH ~ 
                I(log10(citric.acid)) +
...
```{r echo=FALSE, density_over_alcohol_vs_quality}
ggplot(data = wine,
...
```{r echo=FALSE, sulphates_vs_alcohol_vs_quality}
ggplot(data = wine,
...
```{r echo=FALSE, volatile.acidity_vs_alcohol_vs_quality}
ggplot(data = wine,
...
```{r echo=FALSE, pH_vs_alcohol_vs_quality}
ggplot(data = wine,
       aes(y = pH, x = alcohol,
           color = quality)) +
  geom_point()
...
```{r echo=FALSE, citric.acid.final}
qplot(citric.acid, data = wine, binwidth = .01)
```
...
```{r echo=FALSE, sulphates_vs_alcohol_vs_quality.final}
ggplot(data = wine,
       aes(y = sulphates, x = alcohol,
           color = quality)) +
  geom_point() +
